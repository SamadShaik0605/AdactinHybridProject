...
public void verifySelectHotelRoomTypeTC107(HashMap<String, String> data)
{
		//for login page
	       test.log(Status.INFO,"Login Page");
            ...
            selectHotelPage.verifyRoomType(data.get("roomType"));    //verifying Room Type
}
	...
	public Object[][] getTestData()
	{
		...
		data[0][0]=UtilKit.getTestDataFromExcel("TC-107");
