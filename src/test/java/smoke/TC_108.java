...
public void verifyBookAHotelTotalPriceTC108(HashMap<String, String> data)
{
		//for login page
		  ...
		  //System.out.println(finalPriceWithoutGst);
	...
	public Object[][] getTestData()
	{
		...
		data[0][0]=UtilKit.getTestDataFromExcel("TC-108");
