...
public void verifyTotalBillVthGstTC112(HashMap<String, String> data)
{
		//for login page
		   ...
		   bah.finalBillCalc(numberofRooms,totalDays,pricePerNight,finalBilledPrice);   
	...
	public Object[][] getTestData()
	{
		...
		data[0][0]=UtilKit.getTestDataFromExcel("TC-112");
