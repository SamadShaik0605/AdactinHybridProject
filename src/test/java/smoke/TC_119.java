...
public void toCancelGeneratedOrderTC119(HashMap<String, String> data)
{
		//for login page
	       test.log(Status.INFO,"Login Page");
			...
			test.log(Status.INFO, "Book A hotel page");
			 ...
			 bookconfirm.verifyOrderNoGenerated();
			 bookconfirm.scrollIntoViewToOrderNo();
             ...
             bookedItinerary.clickCancelOrderButton();
             bookedItinerary.alertsHandlingAccept();
             bookedItinerary.verifyCancelled(data.get("verifyCancelled"));
             bookedItinerary.searchOrderIdtext(bookingConfirmationOrderId);
             bookedItinerary.clickGo();
             bookedItinerary.verifyResultZero(data.get("verifyResult"));
	...
	public Object[][] getTestData()
	{
		...
		data[0][0]=UtilKit.getTestDataFromExcel("TC-119");
