...
public void verifySelectHotelDatesTC105(HashMap<String, String> data)
{
		//for login page
	       test.log(Status.INFO,"Login Page");
			...
			selectHotelPage.verifyArrivalDate(data.get("checkInDate"));
			selectHotelPage.verifyDepartureDate(data.get("checkOutDate"));
}
